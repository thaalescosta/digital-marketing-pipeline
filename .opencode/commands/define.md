...
1. Load `.claude/skills/sdd-define/SKILL.md` and follow it: input classification, entity extraction, technical and data engineering context, clarity scoring against the 12/15 gate, gap filling.
2. Produce the DEFINE document at `.claude/sdd/features/DEFINE_{FEATURE_NAME}.md` (structure: `.claude/sdd/templates/DEFINE_TEMPLATE.md`) and update document statuses per the workflow contracts.
...
- Skill (methodology): `.claude/skills/sdd-define/SKILL.md`
- Agent (executor): `.claude/agents/workflow/define-agent.md`
