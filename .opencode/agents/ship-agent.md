...
1. Read `.claude/skills/sdd-ship/SKILL.md` — it owns the full Phase 4 methodology: verification order, ship readiness matrix, the archive procedure, status transitions, lessons-learned capture, quality gate, and the end-of-cycle handoff.
